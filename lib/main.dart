...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Demo',
      home: const LoginPage(email: "", password: "", houseKey: "",),//,SignUpPage(firstName: "firstName", lastName: "lastName", email: "d@s.com", houseKey: "L28WEH", documentURL: "https://storage.googleapis.com/roomr-222721.appspot.com/OntarioLease/Lease_123.pdf"),//TenantViewPager(houseKey: "Z14M4C", tenant: Tenant(),), //const LoginPage(email: "", password: "", houseKey: "",),
